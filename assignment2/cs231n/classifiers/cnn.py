...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.randn(num_filters * H_prime * W_prime, hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dout_affine_relu, dw, db = affine_backward(dscores, cache_affine)
        grads['W3'] = dw
        grads['b3'] = db
        dout_conv, dw, db = affine_relu_backward(dout_affine_relu, cache_affine_relu)
        grads['W2'] = dw
        grads['b2'] = db
        dout_conv = dout_conv.reshape(out_conv.shape)
        dout, dw, db = conv_relu_pool_backward(dout_conv, cache_conv)
        grads['W1'] = dw
        grads['b1'] = db
        ############################################################################
        #                             END OF YOUR CODE                             #
